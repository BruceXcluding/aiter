...
kernels_block_scale_list = {
#   id: kernel:        BLOCK_SIZE| Scale Block M| Scale Block N| Scale Block K| MPerBLOCK| NPerBLOCK| KPerBLOCK|       AK1|        BK1| WAVE_TILE_M| WAVE_TILE_N| WAVE_MAP_M| WAVE_MAP_N| ABLOCK_TRANSFER| BBLOCK_TRANSFER| CBLOCK_TRANSFER| CBLOCK_SPV| CSHUFFLE_MX| CSHUFFLE_NX|   LOOP_SCHED| PIPELINE_VERSION
     0: kernelInstance(       256,            1,           128,           128,        128,       128,       128,        16,         16,          32,          32,          2,          2,      [8, 32, 1],      [8, 32, 1],   [1, 32, 1, 8],        [8],           1,           1,  "Intrawave",    3),
     1: kernelInstance(       256,            1,           128,           128,        128,        64,       128,        16,         16,          32,          32,          2,          1,      [8, 32, 1],      [8, 32, 1],   [1, 32, 1, 8],        [8],           1,           1,  "Intrawave",    3),
     2: kernelInstance(       256,            1,           128,           128,         64,       128,       128,        16,         16,          32,          32,          1,          2,      [8, 32, 1],      [8, 32, 1],   [1, 32, 1, 8],        [8],           1,           1,  "Intrawave",    3),
     3: kernelInstance(       256,            1,           128,           128,         64,        64,       128,        16,         16,          32,          32,          1,          1,      [8, 32, 1],      [8, 32, 1],   [1, 32, 1, 8],        [8],           1,           1,  "Intrawave",    3),
     4: kernelInstance(       256,            1,           128,           128,         16,       256,       128,         8,         16,          16,          16,          1,          4,     [16, 16, 1],      [8, 32, 1],  [1, 16, 1, 16],        [8],           1,           2,  "Intrawave",    1),
     5: kernelInstance(       256,            1,           128,           128,         16,       128,       128,         8,         16,          16,          16,          1,          2,     [16, 16, 1],      [8, 32, 1],  [1, 16, 1, 16],        [8],           1,           2,  "Intrawave",    1),
     6: kernelInstance(       256,            1,           128,           128,         16,        64,       128,         8,         16,          16,          16,          1,          1,     [16, 16, 1],      [8, 32, 1],  [1, 16, 1, 16],        [4],           1,           1,  "Intrawave",    1),
     7: kernelInstance(       256,            1,           128,           128,         16,       128,       256,        16,         16,          16,          16,          1,          2,     [16, 16, 1],     [16, 16, 1],  [1, 16, 1, 16],        [8],           1,           2,  "Intrawave",    1),
     8: kernelInstance(       256,            1,           128,           128,         16,        64,       256,        16,         16,          16,          16,          1,          1,     [16, 16, 1],     [16, 16, 1],  [1, 16, 1, 16],        [4],           1,           1,  "Intrawave",    1),
     9: kernelInstance(       256,            1,           128,           128,         32,       256,       128,        16,         16,          32,          32,          1,          2,      [8, 32, 1],      [8, 32, 1],   [1, 32, 1, 8],        [8],           1,           1,  "Intrawave",    1),
    10: kernelInstance(       256,            1,           128,           128,         32,       128,       128,        16,         16,          32,          32,          1,          1,      [8, 32, 1],      [8, 32, 1],   [1, 32, 1, 8],        [8],           1,           1,  "Intrawave",    1),
    11: kernelInstance(       256,            1,           128,           128,         32,        64,       128,        16,         16,          16,          16,          2,          1,      [8, 32, 1],      [8, 32, 1],   [1, 32, 1, 8],        [8],           1,           1,  "Intrawave",    1),
    12: kernelInstance(       256,            1,           128,           128,         32,       128,       256,        16,         16,          32,          32,          1,          1,     [16, 16, 1],     [16, 16, 1],   [1, 32, 1, 8],        [8],           1,           1,  "Intrawave",    1),
    13: kernelInstance(       256,            1,           128,           128,         32,        64,       256,        16,         16,          16,          16,          2,          1,     [16, 16, 1],     [16, 16, 1],   [1, 32, 1, 8],        [8],           1,           1,  "Intrawave",    1),
    14: kernelInstance(       256,            1,           128,           128,         64,       256,       128,        16,         16,          32,          32,          2,          2,      [8, 32, 1],      [8, 32, 1],   [1, 32, 1, 8],        [8],           1,           1,  "Intrawave",    1),
    15: kernelInstance(       256,            1,           128,           128,         64,       128,       128,        16,         16,          32,          32,          2,          1,      [8, 32, 1],      [8, 32, 1],   [1, 32, 1, 8],        [8],           1,           1,  "Intrawave",    1),
    16: kernelInstance(       256,            1,           128,           128,         64,        64,       128,        16,         16,          32,          32,          1,          1,      [8, 32, 1],      [8, 32, 1],   [1, 32, 1, 8],        [8],           1,           1,  "Intrawave",    1),
    17: kernelInstance(       256,            1,           128,           128,         64,       128,       256,        16,         16,          32,          32,          2,          1,     [16, 16, 1],     [16, 16, 1],   [1, 32, 1, 8],        [8],           1,           1,  "Intrawave",    1),
    18: kernelInstance(       256,            1,           128,           128,         64,        64,       256,        16,         16,          32,          32,          1,          1,     [16, 16, 1],     [16, 16, 1],   [1, 32, 1, 8],        [8],           1,           1,  "Intrawave",    1),
